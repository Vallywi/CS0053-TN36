...
- **Program File:** [sample_program.cpp](sample_program.cpp)
...
- **Buggy Program File:** [buggy_program.cpp](buggy_program.cpp)
...
The mini development standard document was created as a standalone reference file: [mini_coding_standard.md](mini_coding_standard.md).
...
### Submitted Artifacts
- [x] **Original Source Code:** [sample_program.cpp](sample_program.cpp)
- [x] **Improved Source Code:** [improved_program.cpp](improved_program.cpp)
- [x] **Buggy Program Code:** [buggy_program.cpp](buggy_program.cpp)
- [x] **Mini Development Standard:** [mini_coding_standard.md](mini_coding_standard.md)
- [x] **Git Repository Commit History:** Tracked on GitHub Repository (`Vallywi/CS0053-TN36`)
- [x] **Laboratory Activity Report:** [LAB_ACTIVITY_REPORT.md](LAB_ACTIVITY_REPORT.md)
